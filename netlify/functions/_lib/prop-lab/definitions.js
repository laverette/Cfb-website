...
const PROP_DEFINITIONS = [
  ...
  {
    // Longest completion is a per-game max — lognormal, never averaged from season LONG.
    id: "pass_long",
    ...
    family: "passing",
    dist: "lognormal",
    sources: ["player_game.passing.long"],
    aggregate: "max",
    methodology: "opportunity_efficiency",
    opportunity: "pass_completions",
  ...
  },
  {
    ...
    family: "receiving",
    dist: "lognormal",
    sources: ["player_game.receiving.long"],
    aggregate: "max",
    methodology: "opportunity_efficiency",
    opportunity: "receptions",
    efficiency: "explosiveness",
  ...
  },
  {
    ...
    family: "kicking",
    dist: "poisson",
    sources: ["player_game.kicking.xpm", "overview.kicking.XPM"],
    methodology: "rate",
    opportunity: "pat_attempts",
    efficiency: "xp_pct",
    minGames: 3,
    priorSd: 1.4,
    floor: 0,
